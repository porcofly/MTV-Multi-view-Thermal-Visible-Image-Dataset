...
TRAIN_BASE_PATH = "/media/yan/data/CCTV7/Loftr"
cfg.DATASET.TRAINVAL_DATA_SOURCE = "MegaDepth"
cfg.DATASET.TRAIN_DATA_ROOT = "/media/yan/data/CCTV7/Loftr"
...
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "/media/yan/data/CCTV7/Loftr"
cfg.DATASET.VAL_NPZ_ROOT = cfg.DATASET.TEST_NPZ_ROOT = f"{TEST_BASE_PATH}/"
